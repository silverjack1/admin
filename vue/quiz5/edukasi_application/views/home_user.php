		...
		<div class="col-md-3">
			<div class="box box-success">
				<div class="box-body box-profile">
					...
					<h3 class="profile-username text-center"><?php echo strtoupper($this->session->userdata("siswaNama")); ?></h3>	
					<center>NIS : <?php echo strtoupper($this->session->userdata("siswaNis")." / ".$this->session->userdata("siswaKelas")." ".$this->session->userdata("jenjang_ket")." ".$this->session->userdata("jurusan_ket")); ?></center>					
					<br>
				</div>
			</div>
		</div>
