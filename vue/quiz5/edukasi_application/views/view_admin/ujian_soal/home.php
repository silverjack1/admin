		...
		<div class="col-md-12">
			<div class="box box-warning">
				<div class="box-body box-profile">
					...
					<button type="submit" class='btn btn-sm btn-primary pull-left' onClick=add_function('<?php echo $mode;?>'); id="submit" name="submit" value="submit">TAMBAH SOAL</button>
					<br><br>
...
$(document).ready(function(){
	$('#my-table').DataTable({responsive: false,
		...
		"order": [[ 1, "desc" ]],
        "ajax" : {
            url: "<?php echo site_url("ujian_soal/soal_ajax"); ?>",
            type: "post",
            error: function() {
                $(".my-table-error").html("");
...
{
    var base_url = "ujian_soal/form?m="+m;
...
function del_function(m,id,lampiran) 
{
    ...
    {
        var base_url = "ujian_soal/delete_soal?m="+m+"&id="+id+"&fl="+lampiran;
        window.location.href = "<?php echo site_url(); ?>"+base_url;
    }else{}
}
