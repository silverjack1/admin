...
<div class="container">
	...
	<form action="" method="post" name="fl" id="f_login">
		...
		<div class="panel panel-primary top150">
			<div class="panel-heading"><h4 style="margin: 5px"><i class="glyphicon glyphicon-user"></i> Aplikasi Ujian Online</h4></div>
			<div class="panel-body">
				...
				<div class="login-actions">
					...
					<br><br><br>
					<center><a href="https://blogbugabagi.blogspot.com" target="_blank" rel="noopener noreferrer">&copy; Copyleft 2019 | AUO</a></center>
				</div> <!-- .actions -->
			</div>
		</div> <!-- /login-fields -->
