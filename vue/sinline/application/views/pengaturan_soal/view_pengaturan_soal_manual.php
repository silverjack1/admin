  ...
  <div class="well">
                  <table class="table table-striped" >
                    ...
                    <tr>
                      <td></td>
                      <td>Waktu Ujian</td>
                      <td class="text-left"> : <?php echo $info_ujian->waktu; ?> Menit / <?php echo $info_ujian->waktu*60; ?> Detik</td>
                    </tr>
                    <tr>
                      <td></td>
                    ...
                    <tr>
                      <td colspan="3" class="text-center"><?php echo "<span class='glyphicon glyphicon-cog'></span> Sulit <span class='label label-danger'>$setting_waktunya->sulit detik</span>"; echo " | <span class='glyphicon glyphicon-cog'></span> Sedang <span class='label label-danger'> $setting_waktunya->sedang detik</span> | <span class='glyphicon glyphicon-cog'></span> Mudah <span class='label label-danger'> $setting_waktunya->mudah detik</span>";
?>
                      </td>
                    </tr>
                    <tr>
...
<form class="form-horizontal" role="form" action="#">
  <div class="form-group">
    ...
    <div class="col-sm-2">
            <input type="text" onkeypress="return isNumberKey(event)" class="form-control" id="tingkat_kesukaran" placeholder="dalam detik">
    </div>
    <div class="col-sm-1">
...
$(document).ready(function() {
  $('#submit').click(function() {
    ...
    $.ajax({
      url: "<?php echo site_url('pengaturan_soal/tambah_soal_manual'); ?>",
      type: 'POST',
      async : false,
      data: form_data,
