...
<form class="form-horizontal" role="form" action="#">
  <div class="form-group">
    <label class="col-sm-2 control-label">Tingkat Kesukaran</label>
    <div class="col-sm-2">
          <select class="form-control" id="tingkat_kesukaran">
            <option <?php $tingkat_kesulitan = str_replace(" ", "", $info_soal->tingkat_kesulitan); if ($tingkat_kesulitan=="sulit")  echo "selected"; ?> value="sulit">sulit</option>
            <option <?php if ($tingkat_kesulitan=="sedang") echo "selected"; ?> value="sedang">sedang</option>
            <option <?php if ($tingkat_kesulitan=="mudah")  echo "selected"; ?> value="mudah">mudah</option>
          </select>
    </div>
    <div class="col-sm-2">
    ...
    <div class="col-sm-4">
      <button type="button" id="submit" class="btn btn-info"><span class='glyphicon glyphicon-save'></span> Simpan perubahan</button>
...
$(document).ready(function() {
  $('#submit').click(function() {
    ...
    $.ajax({
      url: "<?php echo site_url('pengaturan_soal/act_edit_soal'); ?>",
      type: 'POST',
      async : false,
      data: form_data,
