                        ...
                        <div class="uk-width-1-1@s uk-width-3-5@l uk-width-1-3@xl">
                            <div class="uk-card uk-card-default">
                                ...
                                <div class="uk-card-body">
									<center>
                                        <img src="<?php echo base_url("assets/images/logo-user.png"); ?>" width="150"><br><br>
                                    </center>
                                    <form action="<?php echo site_url("auth/validate_credential"); ?>" method="POST">
                                        <fieldset class="uk-fieldset">
                                            ...
                                            <div class="uk-margin">
                                                ...
                                                <button name="tombol_login" value="tombol_login" type="submit" class="uk-button uk-button-primary">Login</button>
                                            </div>
