...
<div class="box">
  <div class="box-header">
    <div class="col-md-12 well">
      <h3 style="display:block; text-align:center;"><i class="fa fa-location-arrow"></i> Kelola Data Siswa<br><br>Tahun Ajaran <b><?php  echo $tahun_ajaran->tahun;?></b></h3>
      ...
      <div class="box box-body">
                      ...
                      <?php
                          foreach ($dataKelasAsal as $kelas) { ?>
                                <option value="<?php echo $kelas->id_kelas ?>" 
                                  <?php if($this->session->userdata('id_kelas_kelola_siswa')== $kelas->id_kelas) echo "selected";?>>
        ...
        <form id="form_absensi" method="POST" action="<?php echo base_url('Kelas/tambahSiswakeKelas/'.$id_ta_sesudah)?>">
          <input type="hidden" name="tahun_ajaran_sebelum" value="<?php echo $tahun_ajaran->id_tahun?>">
          ...
          <table id="tabel_kelola_siswa"  class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th>NIS</th>
                <th>Nama</th>
                <th>Kelas Asal (<?php echo $tahun_ajaran->tahun; ?>)</th>
